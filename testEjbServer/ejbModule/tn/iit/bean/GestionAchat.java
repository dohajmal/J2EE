...
public class GestionAchat implements GestionAchatRemote {
	...
	public void calculTotal(Achat achat, float remise) {
		...
		for (int i = 0; i < list.size(); i++) {
			totale = (list.get(i).getArticle().getPrixAchatHT() * list.get(i).getQuantite())/(achat.getRemise());

		}
		System.out.println(""+achat.getTotalHt());
